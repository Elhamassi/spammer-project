...
Une organisation possible pour accompagner ce README est :
...
├── backend/         # API Flask
└── model/           # Modèle Machine Learning (.pkl)
```

> Cette arborescence est une organisation documentaire proposée pour le dépôt. Le rapport ne fournit pas l'arborescence réelle du projet.

## 📚 Contexte du projet

Le projet met en évidence l'utilisation du Machine Learning dans le domaine du marketing digital, plus particulièrement pour l'analyse du contenu des e-mails.

L'objectif final est de fournir un outil simple permettant de vérifier un contenu avant son envoi afin de réduire le risque qu'il soit identifié comme spam.
...
Ce README a été rédigé à partir du rapport **“Spammer web Application — Angular and Machine Learning”** fourni avec le projet.
